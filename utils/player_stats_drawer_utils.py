...
def draw_player_stats(output_video_frames,player_stats):
    ...
    for index, row in player_stats.iterrows():
        ...
        if math.isnan(avg_player_1_shot_speed):
            avg_player_1_shot_speed = 0
        if math.isnan(avg_player_2_shot_speed):
            avg_player_2_shot_speed = 0
        ...
        if math.isnan(avg_player_1_speed):
            avg_player_1_speed = 0
        if math.isnan(avg_player_2_speed):
            avg_player_2_speed = 0
