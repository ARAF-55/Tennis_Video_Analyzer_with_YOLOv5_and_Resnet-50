...
from constans import DOUBLE_LINE_WIDTH
...
def main():
    ...
    ball_tracker = BallTracker(model_path='models/mod/yolo5_last.pt')
    ...
    ball_shot_frames = ball_tracker.ball_shot_frames(ball_detections)
    ...
    for ball_shot_ind in range(len(ball_shot_frames)-1):
        ...
        ball_shot_time_in_seconds = (end_frame - start_frame)* (1/24)
        ...
        distance_covered_by_ball_meters = convert_pixel_distance_to_meters(
            ...
            DOUBLE_LINE_WIDTH,
            mini_court.court_drawing_width
        )
        ...
        player_shot_ball = min(
            ...
            key = lambda player_id : measure_distance(player_positions[player_id], ball_mini_court_detections[start_frame][1])
        )
